...
try
{
    ...
    $result = Invoke-CaptureStreams "pwsh -File `"$buildScript`" -NonInteractive -tools" -interleave
    ...
    $result = Invoke-CaptureStreams "pwsh -File `"$buildScript`" -NonInteractive -setup -nobuild" -interleave
